...
const data = [
  { name: 'Kaif', value: 42, color: '#ff7c43' },
  { name: 'Jane Smith', value: 28, color: '#ffa600' },
  { name: 'Alex Johnson', value: 19, color: '#f95d6a' },
  { name: 'Sam Wilson', value: 14, color: '#d45087' },
];

const colors = ['#ff7c43', '#ffa600', '#f95d6a', '#d45087'];

export function DocumentUploadBreakdownChart({ data }: { data: { name: string; value: number }[] }) {
  return (
